...
const URI = "https://api.render.com/deploy/srv-ciolfp6nqqlfegd927e0?key=i0Gz58yml08/sendEmailBuy";//Direccion a la que van las peticiones
...
export default function PaymentForm() {
    ...
    if(!error){
        try {
            ...
            const response = await axios.post("https://api.render.com/deploy/srv-ciolfp6nqqlfegd927e0?key=i0Gz58yml08/", { //se cre una peticion para el pago
