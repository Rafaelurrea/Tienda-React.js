...
const URI = "https://tienda-virtual-k237.onrender.com/users/sendEmailBuy";//Direccion a la que van las peticiones
...
export default function PaymentForm() {
    ...
    if(!error){
        try {
            ...
            const response = await axios.post("https://tienda-virtual-k237.onrender.com/payment", { //se cre una peticion para el pago
